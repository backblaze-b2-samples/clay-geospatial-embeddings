...
const navItems = [
  ...
  { title: "Embedding Jobs", href: "/jobs", icon: Layers },
  { title: "Imagery Library", href: "/library", icon: Images },
  { title: "Similarity Search", href: "/search", icon: Search },
  ...
  return (
    <Sidebar>
      ...
      <SidebarFooter className="border-t border-sidebar-border px-4 py-3">
        <a
          href="https://www.backblaze.com/cloud-storage?utm_source=github&utm_medium=referral&utm_campaign=ai_artifacts&utm_content=b2ai-clay-geospatial-embeddings"
          target="_blank"
