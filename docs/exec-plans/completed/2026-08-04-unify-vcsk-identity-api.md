...
Make Clay Geospatial Embeddings the canonical identity across the shipped web app,
...
The web app and local API now ship under the Clay Geospatial Embeddings identity.
