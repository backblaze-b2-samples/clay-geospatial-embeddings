...
API_TITLE = "Clay Geospatial Embeddings API"
API_DESCRIPTION = (
    "Local API for Clay Geospatial Embeddings: run the Clay foundation model "
    "on satellite/aerial imagery tiles stored in Backblaze B2, write embedding "
    "tensors back to B2, and run k-NN similarity search over the archive. This "
