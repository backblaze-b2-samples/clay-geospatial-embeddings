...
def _client():
    ...
    # client leaves region unset for object ops. The region is read from
    # B2_REGION, so no endpoint host or region slug is hardcoded here.
    return boto3.client(
        "s3",
        ...
        config=Config(signature_version="s3v4", user_agent_extra="b2ai-clay-geospatial-embeddings"),
    )
